            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card" style="max-width: 800px">
                        <div class="card-header"><h3>總經銷商 編輯</h3></div>
                        <div class="card-body">
                        {!! Form::model($dealer,['url' => '/admin/dealer/'.$dealer->id ,'method' => 'PATCH','enctype'=>'multipart/form-data'])  !!}
                            ...
                            <div class="form-group" style="text-align:center">
                                ...
                                <a class="btn btn-success" href="{{ url('/admin/dealer?bid='.$dealer->id ) }}">取消及回上一列表</a>
                            </div>
                            {!! Form::close() !!}
                        </div>
                    </div>
