            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card" style="max-width: 800px">
                        <div class="card-header"><h3>總經銷商 新增</h3></div>
                        <div class="card-body">
                        {!! Form::open(['url' => '/admin/dealer','enctype'=>'multipart/form-data'])  !!}
                        <!-- title Form text Input -->
                            <div class="form-group row">
                                {!! Form::label('title',"總經銷商名稱:",['class'=>'col-sm-3 form-control-label']) !!}
                                <div class="col-sm-9">
                            ...
                            <!-- 月結% Form text Input -->
                            <div class="form-group row">
                                {!! Form::label('rate_carplus',"格上網站來源 月結%:",['class'=>'col-sm-3 form-control-label']) !!}
                                <div class="col-sm-9">
                                    {!! Form::number('rate_carplus', null,['class'=>'form-control','step'=>'any']); !!}
                                    @if($errors->has('rate_carplus'))
                                        <div class="alert alert-danger " role="alert" style="margin-top:5px">
                                            <i class="fa fa-warning"></i>{{ $errors->first('rate_carplus') }}
                                        </div>
                                    @endif
                                </div>
                            </div>
                            ...
                            <!-- 月結% Form text Input -->
                            <div class="form-group row">
                                {!! Form::label('rate_carplus_commission',"格上網站來源 格上傭金%:",['class'=>'col-sm-3 form-control-label']) !!}
                                <div class="col-sm-9">
                                    {!! Form::number('rate_carplus_commission', null,['class'=>'form-control','step'=>'any']); !!}
                                    @if($errors->has('rate_carplus_commission'))
                                        <div class="alert alert-danger " role="alert" style="margin-top:5px">
                                            <i class="fa fa-warning"></i>{{ $errors->first('rate_carplus_commission') }}
                                        </div>
                                    @endif
                                </div>
                            </div>
                            ...
                            <!-- 月結% Form text Input -->
                            <div class="form-group row">
                                {!! Form::label('rate_sealand',"格上網站來源 格上傭金%:",['class'=>'col-sm-3 form-control-label']) !!}
                                <div class="col-sm-9">
                                    {!! Form::number('rate_sealand', null,['class'=>'form-control','step'=>'any']); !!}
                                    @if($errors->has('rate_sealand'))
                                        <div class="alert alert-danger " role="alert" style="margin-top:5px">
                                            <i class="fa fa-warning"></i>{{ $errors->first('rate_sealand') }}
                                        </div>
                                    @endif
                                </div>
                            </div>
                            ...
                            <!-- 月結% Form text Input -->
                            <div class="form-group row">
                                {!! Form::label('rate_sealand',"Sealand網站來源 月結%:",['class'=>'col-sm-3 form-control-label']) !!}
                                <div class="col-sm-9">
                                    {!! Form::number('rate_sealand', null,['class'=>'form-control','step'=>'any']); !!}
                                    @if($errors->has('rate_sealand'))
                                        <div class="alert alert-danger " role="alert" style="margin-top:5px">
                            ...
                            <div class="form-group" style="text-align:center">
                                ...
                                <a class="btn btn-success" href="{{ url('/admin/dealer' ) }}">取消及回上一列表</a>
                            </div>
                            {!! Form::close() !!}
                        </div>
                    </div>
