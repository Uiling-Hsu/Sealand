            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card" style="max-width: 800px">
                        <div class="card-header"><h3>假日 新增</h3></div>
                        <div class="card-body">
                            {!! Form::open(['url' => '/admin/holiday'])  !!}
                                ...
                                <!-- 持續天數 Form text Input -->
                                <div class="form-group row">
                                    {!! Form::label('keepdays',"持續天數:",['class'=>'col-sm-2 form-control-label']) !!}
                                    <div class="col-sm-10">
                                        {!! Form::text('keepdays',1,['class'=>'form-control']) !!}
                                        @if($errors->has('keepdays'))
                                            <div class="alert alert-danger " role="alert" style="margin-top:5px">
                                                <i class="fa fa-warning"></i> {{ $errors->first('keepdays') }}
                                            </div>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="form-group" style="text-align:center">
                                    ...
                                    <a class="btn btn-warning" href="{{ URL::previous() }}">取消</a>
                                </div>
