                ...
                <div class="row align-items-end">
                    <div class="col-lg-8">
                        <div class="page-header-title">
                            ...
                            <div class="d-inline">
                                <h5 style="margin-bottom: 5px;position:relative;top:10px">訂單重新選擇車輛</h5>
                                {{--                                <span>各項參數選擇車輛</span>--}}
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <nav class="breadcrumb-container" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#">訂單重新選擇車輛</a></li>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    {!! Form::open(['url' => '/admin/selectcar/'.$subscriber->id,'name'=>'form_search','method'=>'GET'])  !!}
                                    <div class="form-row">
                                        <div class="form-group col-md-3">
                                            <label for="search_partner_id">經銷商</label>
                                            {!! Form::select('search_partner_id', $list_partners , $search_partner_id ,['id'=>'partner','class'=>'form-control','style'=>'font-size:15px','onchange'=>'document.location.href="?search_partner_id="+this.value;']) !!}
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label for="search_brandcat_id">品牌 (請先選擇方案類別)</label>
                                            {!! Form::select('search_brandcat_id', $list_brandcats , $search_brandcat_id ,['id'=>'brandcat','class'=>'form-control','style'=>'font-size:15px','onchange'=>'document.location.href="?search_partner_id="+document.getElementById("partner").value+"&search_brandcat_id="+this.value;']) !!}
                                        </div>
                                        <div class="form-group col-md-3">
