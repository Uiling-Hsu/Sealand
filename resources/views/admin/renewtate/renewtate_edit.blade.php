            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card" style="max-width: 800px">
                        <div class="card-header"><h3>訂單續約狀態 編輯</h3></div>
                        <div class="card-body">
                        {!! Form::model($renewtate,['url' => '/admin/renewtate/'.$renewtate->id ,'method' => 'PATCH','enctype'=>'multipart/form-data'])  !!}

                            <!-- title Form text Input -->
                            <div class="form-group row">
                                {!! Form::label('ftitle',"訂單續約狀態名稱(前台):",['class'=>'col-sm-3 form-control-label']) !!}
                                <div class="col-sm-9">
                                    {!! Form::text('ftitle',null,['class'=>'form-control']) !!}
                                    @if($errors->has('ftitle'))
                                        <div class="alert alert-danger " role="alert" style="margin-top:5px">
                                            <i class="fa fa-warning"></i>{{ $errors->first('ftitle') }}
                                        </div>
                                    @endif
                                </div>
                            </div>
                            ...
                            <!-- title Form text Input -->
                            <div class="form-group row">
                                {!! Form::label('title',"訂單續約狀態名稱(後台):",['class'=>'col-sm-3 form-control-label']) !!}
                                <div class="col-sm-9">
                            ...
                            <div class="form-group" style="text-align:center">
                                ...
                                <a class="btn btn-success" href="{{ url('/admin/renewtate?bid='.$renewtate->id ) }}">取消及回上一列表</a>
                            </div>
                            {!! Form::close() !!}
                        </div>
                    </div>
