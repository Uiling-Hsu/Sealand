            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card" style="max-width: 800px">
                        <div class="card-header"><h3>訂單續約狀態 新增</h3></div>
                        <div class="card-body">
                        {!! Form::open(['url' => '/admin/renewtate','enctype'=>'multipart/form-data'])  !!}
                        <!-- title Form text Input -->
                            <div class="form-group row">
                                {!! Form::label('title',"續約狀態名稱(後台):",['class'=>'col-sm-3 form-control-label']) !!}
                                <div class="col-sm-9">
                            ...
                            <div class="form-group" style="text-align:center">
                                ...
                                <a class="btn btn-success" href="{{ url('/admin/renewtate' ) }}">取消及回上一列表</a>
                            </div>
                            {!! Form::close() !!}
                        </div>
                    </div>
