            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card" style="max-width: 800px">
                        <div class="card-header"><h3>權限項目 編輯</h3></div>
                        <div class="card-body">
                            {!! Form::model($permission,['url' => '/admin/permission/'.$permission->id ,'method' => 'PATCH','enctype'=>'multipart/form-data'])  !!}
                                ...
                                <div class="form-group" style="text-align:center">
                                    ...
                                    <a class="btn btn-success" href="{{ url('/admin/permission?bid='.$permission->id ) }}">取消及回上一頁</a>
                                </div>
                            {!! Form::close() !!}
                        </div>
                    </div>
