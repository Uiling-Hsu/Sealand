            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card" style="max-width: 800px">
                        <div class="card-header"><h3>訂閱租期及折扣 編輯</h3></div>
                        <div class="card-body">
                        {!! Form::model($period,['url' => '/admin/period/'.$period->id ,'method' => 'PATCH','enctype'=>'multipart/form-data'])  !!}

                            <!-- title Form text Input -->
                            <div class="form-group row">
                                {!! Form::label('title',"租期名稱:",['class'=>'col-sm-2 form-control-label']) !!}
                                <div class="col-sm-10">
                            ...
                            <div class="form-group row">
                                {!! Form::label('months',"月數:",['class'=>'col-sm-2 form-control-label']) !!}
                                <div class="col-sm-10">
                                    {!! Form::number('months',null,['class'=>'form-control','min'=>'1']) !!}
                                    @if($errors->has('months'))
                                        <div class="alert alert-danger " role="alert" style="margin-top:5px">
                                            <i class="fa fa-warning"></i>{{ $errors->first('months') }}
                                        </div>
                                    @endif
                                </div>
                            </div>
                            ...
                            <!-- title Form text Input -->
                            <div class="form-group row">
                                {!! Form::label('discount',"折扣:(Ex: 輸入90=>打9折)",['class'=>'col-sm-2 form-control-label']) !!}
                                <div class="col-sm-10">
                                    {!! Form::text('discount',null,['class'=>'form-control']) !!}
                                    @if($errors->has('discount'))
                                        <div class="alert alert-danger " role="alert" style="margin-top:5px">
                                            <i class="fa fa-warning"></i>{{ $errors->first('discount') }}
                                        </div>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="form-group" style="text-align:center">
                                ...
                                <a class="btn btn-success" href="{{ url('/admin/period?bid='.$period->id ) }}">取消及回上一列表</a>
                            </div>
                            {!! Form::close() !!}
                        </div>
                    </div>
