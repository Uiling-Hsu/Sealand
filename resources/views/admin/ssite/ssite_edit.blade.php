            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card" style="max-width: 800px">
                        <div class="card-header"><h3>發證地點代碼 編輯</h3></div>
                        <div class="card-body">
                        {!! Form::model($ssite,['url' => '/admin/ssite/'.$ssite->id ,'method' => 'PATCH','enctype'=>'multipart/form-data'])  !!}

                            <!-- title Form text Input -->
                            <div class="form-group row">
                                {!! Form::label('title',"發證地點名稱:",['class'=>'col-sm-2 form-control-label']) !!}
                                <div class="col-sm-10">
                            ...
                            <!-- title Form text Input -->
                            <div class="form-group row">
                                {!! Form::label('code',"發證代碼:",['class'=>'col-sm-2 form-control-label']) !!}
                                <div class="col-sm-10">
                                    {!! Form::text('code',null,['class'=>'form-control']) !!}
                                    @if($errors->has('code'))
                                        <div class="alert alert-danger " role="alert" style="margin-top:5px">
                                            <i class="fa fa-warning"></i>{{ $errors->first('code') }}
                                        </div>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="form-group" style="text-align:center">
                                ...
                                <a class="btn btn-success" href="{{ url('/admin/ssite?bid='.$ssite->id ) }}">取消及回上一列表</a>
                            </div>
                            {!! Form::close() !!}
                        </div>
                    </div>
