            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card" style="max-width: 800px">
                        <div class="card-header"><h3>發證地點代碼 新增</h3></div>
                        <div class="card-body">
                        {!! Form::open(['url' => '/admin/ssite','enctype'=>'multipart/form-data'])  !!}
                        <!-- title Form text Input -->
                            <div class="form-group row">
                                {!! Form::label('title',"發證地點代碼名稱:",['class'=>'col-sm-2 form-control-label']) !!}
                                <div class="col-sm-10">
                            ...
                            <div class="form-group" style="text-align:center">
                                ...
                                <a class="btn btn-success" href="{{ url('/admin/ssite' ) }}">取消及回上一列表</a>
                            </div>
                            {!! Form::close() !!}
                        </div>
                    </div>
