            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card" style="max-width: 800px">
                        <div class="card-header"><h3>車型 新增</h3></div>
                        <div class="card-body">
                            {!! Form::open(['url' => '/admin/brandin','enctype'=>'multipart/form-data'])  !!}
                                ...
                                <div class="form-group" style="text-align:center">
                                    ...
                                    <a class="btn btn-success" href="{{ url('/admin/brandin?search_cate_id='.$cate->id.'&search_brandcat_id='.$brandcat->id ) }}">取消及回上一列表</a>
                                </div>
