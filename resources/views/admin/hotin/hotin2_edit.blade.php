            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card" style="max-width: 800px">
                        <div class="card-header"><h3>最新消息段落 編輯</h3></div>
                        <div class="card-body">
                            {!! Form::model($hotin2,['url' => '/admin/hotin2/'.$hotin2->id ,'method' => 'PATCH','enctype'=>'multipart/form-data'])  !!}
                                {!! Form::hidden('hotin_id',null) !!}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        @if($hotin2->image)
                                            <span>{{ Html::image($hotin2->image,null,['class'=>'img-responsive','style'=>'width:300px']) }}
                                        <div style='padding-top:15px;width:500px;text-align:center;border-radius: 10px'>
                                            <a href="{{ url('/admin/hotin2/del_img/'.$hotin2->id.'/image' ) }}" class="btn btn-danger" onclick='return confirm("是否確定要刪除此圖片?");'>刪除此圖</a>
                                        </div>
                                        @endif
                                    </div>
                                ...
                                <div class="form-group" style="text-align:center">
                                    ...
                                    <a class="btn btn-success" href="{{ url('/admin/hotin/'.$hotin2->hotin_id.'/edit?bid='.$hotin2->id.'#list' ) }}">取消及回上一頁</a>
                                </div>
                            {!! Form::close() !!}
                        </div>
                    </div>
