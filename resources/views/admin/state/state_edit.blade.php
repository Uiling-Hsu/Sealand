            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card" style="max-width: 800px">
                        <div class="card-header"><h3>訂單狀態 編輯</h3></div>
                        <div class="card-body">
                        {!! Form::model($state,['url' => '/admin/state/'.$state->id ,'method' => 'PATCH','enctype'=>'multipart/form-data'])  !!}

                            <!-- title Form text Input -->
                            <div class="form-group row">
                                {!! Form::label('ftitle',"訂單狀態名稱(前台):",['class'=>'col-sm-2 form-control-label']) !!}
                                <div class="col-sm-10">
                            ...
                            <!-- title Form text Input -->
                            <div class="form-group row">
                                {!! Form::label('title',"訂單狀態名稱(後台):",['class'=>'col-sm-2 form-control-label']) !!}
                                <div class="col-sm-10">
                            ...
                            <div class="form-group" style="text-align:center">
                                ...
                                <a class="btn btn-success" href="{{ url('/admin/state?bid='.$state->id ) }}">取消及回上一列表</a>
                            </div>
                            {!! Form::close() !!}
                        </div>
                    </div>
