            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card" style="max-width: 800px">
                        <div class="card-header"><h3>原車續租狀態 編輯</h3></div>
                        <div class="card-body">
                        {!! Form::model($samecartate,['url' => '/admin/samecartate/'.$samecartate->id ,'method' => 'PATCH','enctype'=>'multipart/form-data'])  !!}

                            <!-- title Form text Input -->
                            <div class="form-group row">
                                {!! Form::label('title',"原車續租狀態名稱:",['class'=>'col-sm-3 form-control-label']) !!}
                                <div class="col-sm-9">
                            ...
                            <div class="form-group" style="text-align:center">
                                ...
                                <a class="btn btn-success" href="{{ url('/admin/samecartate?bid='.$samecartate->id ) }}">取消及回上一列表</a>
                            </div>
                            {!! Form::close() !!}
                        </div>
                    </div>
