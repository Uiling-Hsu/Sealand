            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card" style="max-width: 800px">
                        <div class="card-header"><h3>原車續租狀態 新增</h3></div>
                        <div class="card-body">
                        {!! Form::open(['url' => '/admin/samecartate','enctype'=>'multipart/form-data'])  !!}
                        <!-- title Form text Input -->
                            <div class="form-group row">
                                {!! Form::label('title',"續約狀態名稱:",['class'=>'col-sm-3 form-control-label']) !!}
                                <div class="col-sm-9">
                            ...
                            <div class="form-group" style="text-align:center">
                                ...
                                <a class="btn btn-success" href="{{ url('/admin/samecartate' ) }}">取消及回上一列表</a>
                            </div>
                            {!! Form::close() !!}
                        </div>
                    </div>
