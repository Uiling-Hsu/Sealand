            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card" style="max-width: 800px">
                        <div class="card-header"><h3>關於我們 新增</h3></div>
                        <div class="card-body">
                            {!! Form::open(['url' => '/admin/aboutin','enctype'=>'multipart/form-data'])  !!}
                                ...
                                <div class="form-group row">
                                    {!! Form::label('content01',"內容:",['class'=>'col-sm-2 form-control-label']) !!}
                                    <div class="col-sm-10">
                                        {!! Form::textarea('content01', null,  ['class'=>'form-control']) !!}
                                        <div>
                                            @if($errors->has('content01'))
                                                <div class="alert alert-danger " role="alert" style="margin-top:5px">
                                                    <i class="fa fa-warning"></i>{{ $errors->first('content01') }}
                                                </div>
                                            @endif
                                        </div>
                                    </div>
                                ...
                                <div class="form-group" style="text-align:center">
                                    ...
                                    <a class="btn btn-success" href="{{ url('/admin/aboutin' ) }}">取消及回上一列表</a>
                                </div>
