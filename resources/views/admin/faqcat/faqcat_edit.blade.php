            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card" style="max-width: 800px">
                        <div class="card-header"><h3>FAQ分類 編輯</h3></div>
                        <div class="card-body">
                            {!! Form::model($faqcat,['url' => '/admin/faqcat/'.$faqcat->id ,'method' => 'PATCH','enctype'=>'multipart/form-data'])  !!}

                                <!-- title Form text Input -->
                                <div class="form-group row">
                                    {!! Form::label('title_tw',"類別名稱:",['class'=>'col-sm-2 form-control-label']) !!}
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group" style="text-align:center">
                                    ...
                                    <a class="btn btn-success" href="{{ url('/admin/faqcat?bid='.$faqcat->id ) }}">取消及回上一列表</a>
                                </div>
                            {!! Form::close() !!}
                        </div>
                    </div>
