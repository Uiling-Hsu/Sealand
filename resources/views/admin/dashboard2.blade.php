...
@section('extra-css')
    ...
    <link rel="stylesheet" href="/back_assets/plugins/datatables.net-bs4/css/dataTables.bootstrap4.min.css">
    <link rel="stylesheet" href="/back_assets/plugins/jvectormap/jquery-jvectormap.css">
    <link rel="stylesheet" href="/back_assets/plugins/tempusdominus-bootstrap-4/build/css/tempusdominus-bootstrap-4.min.css">
    <link rel="stylesheet" href="/back_assets/plugins/weather-icons/css/weather-icons.min.css">
    <link rel="stylesheet" href="/back_assets/plugins/c3/c3.min.css">
    <link rel="stylesheet" href="/back_assets/plugins/owl.carousel/dist/assets/owl.carousel.min.css">
    <link rel="stylesheet" href="/back_assets/plugins/owl.carousel/dist/assets/owl.theme.default.min.css">
    <link rel="stylesheet" href="/back_assets/dist/css/theme.css">
@endsection
@section('top-extra-js')
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body chat-box scrollable" style="height:300px;">
                            <ul class="chat-list">
                                <li class="chat-item">
                                    <div class="chat-img"><img src="/back_assets/img/users/1.jpg" alt="user"></div>
                                ...
                                <li class="chat-item">
                                    <div class="chat-img"><img src="/back_assets/img/users/2.jpg" alt="user"></div>
                                    <div class="chat-content">
                                ...
                                <li class="chat-item">
                                    <div class="chat-img"><img src="/back_assets/img/users/3.jpg" alt="user"></div>
                                    <div class="chat-content">
                ...
                <div class="col-md-4">
                    <div class="card" style="min-height: 422px;">
                        ...
                        <div class="card-body timeline">
                            <div class="header bg-theme" style="background-image: url('/back_assets/img/placeholder/placeimg_400_200_nature.jpg')">
                ...
                <div class="card-body">
                    <table id="advanced_table" class="table">
                        ...
                        <tr>
                            ...
                            <td><img src="/back_assets/img/users/1.jpg" class="table-user-thumb" alt=""></td>
                            <td>Tiger Nixon</td>
                        ...
                        <tr>
                            ...
                            <td><img src="/back_assets/img/users/2.jpg" class="table-user-thumb" alt=""></td>
                        ...
                        <tr>
                            ...
                            <td><img src="/back_assets/img/users/3.jpg" class="table-user-thumb" alt=""></td>
                            <td>Ashton Cox</td>
                        ...
                        <tr>
                            ...
                            <td><img src="/back_assets/img/users/4.jpg" class="table-user-thumb" alt=""></td>
                            <td>Cedric Kelly</td>
                        ...
                        <tr>
                            ...
                            <td><img src="/back_assets/img/users/5.jpg" class="table-user-thumb" alt=""></td>
                            <td>Airi Satou</td>
                            <td>Accountant</td>
                            <td>Tokyo</td>
                            <td>33</td>
...
@section('extra-js')
    ...
    <script src="/back_assets/plugins/datatables.net/js/jquery.dataTables.min.js"></script>
    <script src="/back_assets/plugins/datatables.net-bs4/js/dataTables.bootstrap4.min.js"></script>
    <script src="/back_assets/plugins/datatables.net-responsive/js/dataTables.responsive.min.js"></script>
    <script src="/back_assets/plugins/datatables.net-responsive-bs4/js/responsive.bootstrap4.min.js"></script>
    <script src="/back_assets/plugins/jvectormap/jquery-jvectormap.min.js"></script>
    <script src="/back_assets/plugins/jvectormap/tests/assets/jquery-jvectormap-world-mill-en.js"></script>
    <script src="/back_assets/plugins/moment/moment.js"></script>
    <script src="/back_assets/plugins/tempusdominus-bootstrap-4/build/js/tempusdominus-bootstrap-4.min.js"></script>
    <script src="/back_assets/plugins/d3/dist/d3.min.js"></script>
    <script src="/back_assets/plugins/c3/c3.min.js"></script>
    <script src="/back_assets/js/tables.js"></script>
    <script src="/back_assets/js/widgets.js"></script>
    <script src="/back_assets/js/charts.js"></script>
