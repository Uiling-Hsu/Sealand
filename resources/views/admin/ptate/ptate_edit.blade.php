            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card" style="max-width: 800px">
                        <div class="card-header"><h3>車輛狀態 編輯</h3></div>
                        <div class="card-body">
                        {!! Form::model($ptate,['url' => '/admin/ptate/'.$ptate->id ,'method' => 'PATCH','enctype'=>'multipart/form-data'])  !!}

                            <!-- title Form text Input -->
                            {{--<div class="form-group row">
                                {!! Form::label('ftitle',"車輛狀態名稱(前台):",['class'=>'col-sm-2 form-control-label']) !!}
                                <div class="col-sm-10">
                            ...
                            <!-- title Form text Input -->
                            <div class="form-group row">
                                {!! Form::label('title',"車輛狀態名稱:",['class'=>'col-sm-2 form-control-label']) !!}
                                <div class="col-sm-10">
                            ...
                            <div class="form-group" style="text-align:center">
                                ...
                                <a class="btn btn-success" href="{{ url('/admin/ptate?bid='.$ptate->id ) }}">取消及回上一列表</a>
                            </div>
                            {!! Form::close() !!}
                        </div>
                    </div>
