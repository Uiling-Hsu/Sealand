...
<head>
    ...
    <title>{{setting('store_name')}} 後台管理系統--登入</title>
    ...
    <div class="container-fluid h-100">
        ...
        <div class="row flex-row h-100 bg-white">
            <div class="col-xl-8 col-lg-6 col-md-5 p-0 d-md-block d-lg-block d-sm-none d-none">
                <div class="lavalite-bg" style="background-image: url('/assets/images/slider01-2-1920x1149.png')">
                    <div class="lavalite-overlay" style="opacity: 0.2"></div>
                </div>
            </div>
            <div class="col-xl-4 col-lg-6 col-md-7 my-auto p-0">
                <div class="authentication-form mx-auto">
                        <a href="/"><img src="/back_assets/img/logo.png" alt=""></a>
                    <div>&nbsp;</div>
                    <div>&nbsp;</div>
                    <h3>登入到後台管理系統</h3>
                    <p>請輸入帳號及密碼： </p>
                    {!! Form::open(['url' => 'admin/authenticate','class'=>'form-horizontal m-t-20','id'=>'loginform'])  !!}
                        ...
                        <div class="form-group">
                            <input id="password" type="password" class="form-control" name="password" placeholder="密碼" required autofocus>
