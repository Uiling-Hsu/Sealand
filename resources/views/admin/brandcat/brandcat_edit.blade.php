            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card" style="max-width: 800px">
                        <div class="card-header"><h3>品牌 編輯</h3></div>
                        <div class="card-body">
                        {!! Form::model($brandcat,['url' => '/admin/brandcat/'.$brandcat->id ,'method' => 'PATCH','enctype'=>'multipart/form-data'])  !!}
                            <!--  Form select Input -->
                            <div class="form-group row">
                                {!! Form::label('cate_id',"方案類別名稱:",['class'=>'col-sm-2 form-control-label']) !!}
                                <div class="col-sm-10">
                                    {{$brandcat->cate?$brandcat->cate->title:''}}
                                </div>
                            </div>

                            <!-- title Form text Input -->
                            <div class="form-group row">
                                {!! Form::label('title',"品牌名稱:",['class'=>'col-sm-2 form-control-label']) !!}
                                <div class="col-sm-10">
                            ...
                            <div class="form-group" style="text-align:center">
                                ...
                                <a class="btn btn-success" href="{{ url('/admin/brandcat?bid='.$brandcat->id.'&search_cate_id='.$search_cate_id ) }}">取消及回上一列表</a>
                            </div>
                            {!! Form::close() !!}
                        </div>
                    </div>
