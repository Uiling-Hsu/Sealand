                ...
                <div class="row align-items-end">
                    <div class="col-lg-8">
                        <div class="page-header-title">
                            ...
                            <div class="d-inline">
                                <h5 style="margin-bottom: 5px;position:relative;top:10px">訂閱說明分類</h5>
                                {{--                                <span>各項參數訂閱說明分類編輯</span>--}}
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <nav class="breadcrumb-container" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#">訂閱說明分類</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card" style="max-width: 800px">
                        <div class="card-header"><h3>訂閱說明分類 編輯</h3></div>
                        <div class="card-body">
                            {!! Form::model($flowcat,['url' => '/admin/flowcat/'.$flowcat->id ,'method' => 'PATCH','enctype'=>'multipart/form-data'])  !!}

                                <!-- title Form text Input -->
                                <div class="form-group row">
                                    {!! Form::label('title',"類別名稱:",['class'=>'col-sm-2 form-control-label']) !!}
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group" style="text-align:center">
                                    ...
                                    <a class="btn btn-success" href="{{ url('/admin/flowcat?bid='.$flowcat->id ) }}">取消及回上一列表</a>
                                </div>
                            {!! Form::close() !!}
                        </div>
                    </div>
