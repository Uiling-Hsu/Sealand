                        ...
                        <div class="featured-boxes">
                            <div class="row">
                                <div class="col-md-12" style="max-width: 500px;margin: 0 auto;background-color: #fff;border-radius: 20px;padding: 25px">
                                    ...
                                    <div>&nbsp;</div>
                                    <div class="text-3">請輸入您註冊的電子郵件，可收到一封密碼重置連結的Email。</div>
                                    <div>&nbsp;</div>
                                    <div class="featured-box featured-box-primary text-left mt-2">
                                        <div class="box-content">
                                            <h4 class=" text-3 text-uppercase mb-3 text-right" style="color: red;font-weight: 400;">( * 必填欄位 )</h4>
                                            <form class="form-horizontal" role="form" method="POST" action="{{ route('carplus.user.password.email') }}">
                                                {{ csrf_field() }}
                                                <div class="form-row">
                                                    <div class="form-group col">
                                                        <label class="font-weight-bold text-dark text-3">帳號(Email) <span style="color: red;"> *</span></label>
                                                        {!! Form::email('email', null,['class'=>'form-control form-control-md input','id'=>'email','placeholder'=>'','required'=>'required']); !!}
                                                        @if($errors->has('email'))
