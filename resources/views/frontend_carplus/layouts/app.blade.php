...
<body>
    @include('frontend_carplus.layouts.partials.message')
    @include('frontend_carplus.layouts.partials.modal')
    @include('frontend_carplus.layouts.header')
    ...
    <div>&nbsp;</div>
    @yield('content')
    @include('frontend_carplus.layouts.footer')
    ...
    @yield('extra-js')
    {{--@include('frontend_carplus.layouts.partials.scrollup')--}}
    <!-- GetButton.io widget -->
    <style>
        .clear{color:white}
    ...
    <!-- Global site tag (gtag.js) - Google Analytics -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-14L78BQYFB"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'G-14L78BQYFB');
    </script>
</body>
</html>
