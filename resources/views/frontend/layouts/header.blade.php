    ...
    <nav class="navbar navbar-dropdown navbar-fixed-top navbar-expand-lg" style="padding:0;margin:0">
        ...
        <div class="navbar-toggler">
            <span style="padding-right: 10px;position:relative;top:5px">
                <a href="/flow" class="text-secondary">訂閱說明</a>
            </span>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true">
                ...
                {{--<li class="nav-item">
                    <a class="nav-link link text-secondary display-7" href="/about_1">訂閱說明</a>
                </li>--}}
                <li class="nav-item dropdown">
                    <a class="nav-link link dropdown-toggle text-secondary display-7" href="#" data-toggle="dropdown-submenu" aria-expanded="false">訂閱說明</a>
                    <div class="dropdown-menu">
                        @php
