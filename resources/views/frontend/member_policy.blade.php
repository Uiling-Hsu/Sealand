            ...
            <div class="container">
                <div class="row mt-5">
                    <div class="col-md-12 align-self-center p-static order-2 text-center">
                        ...
                        <div class="text-7 text-color-white" style="padding-top: 10px">客戶服務 <strong>條款</strong></div>
                    </div>
                    <div class="col-md-12 align-self-center order-1">
                        <ul class="breadcrumb breadcrumb-light d-block text-center">
                            <li class="text-4"><a href="#">Member Service Policy</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="container py-2">
                <div class="row">
                    <div class="col" style="max-width: 800px;margin: 0 auto">
                        <h2 class="font-weight-normal text-5 mb-2"><strong class="font-weight-extra-bold">客戶服務</strong> 條款</h2>
