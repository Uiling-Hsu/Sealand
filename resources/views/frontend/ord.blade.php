                                    ...
                                    @else
                                        ...
                                        @if($ord->state_id>=6)
                                            <div style="text-align: left;padding-left:20px;padding-top: 5px">
                                                ...
                                                @endif
                                                @if($ord->state_id==7 && $ord->is_renewtate_setting_finish==0)
                                                    <hr>
                                                    @if($left_days <= setting('user_renewal_start_days') && $left_days >= setting('user_renewal_end_days'))
                                                    ...
                                                    @else
                                                        您已設定：{{$ord->renewtate?$ord->renewtate->ftitle:''}}
                                                    @endif
                                                    <hr>
                                                @endif
                                            </div>
                                                                    ...
                                                                    {!! Form::open(['url' => '/checkout/creditPaid'])  !!}
                                                                        {{--<div class="form-group col-lg-12" style="text-align: center;">
                                                                            <div class="custom-control custom-checkbox">
                                                                                ...
                                                                                <label class="custom-control-label text-2" for="terms">我同意 <a href="#" onclick="policy_cnt=1" data-toggle="modal" data-target="#mbr-popup-1h">Sealand及車源商的電子契約</a></label>
                                                                            </div>
                                                                        </div>--}}
                                                                        {{--<table style="text-align: center;width: 90%;margin-left: 30px">
                                                                            <tr>
                                                                                ...
                                                                                <td style="text-align: left;">&nbsp;&nbsp;<label for="terms">我同意 Sealand <a href="/pdf/SeaLand_會員合約訂閱車輛規定.pdf" onclick="t1=1;" target="_blank">會員合約訂閱車輛規定</a></label></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td style="position: relative;top: -3px"><input type="checkbox" id="terms2"></td>
                                                                                <td style="text-align: left;">&nbsp;&nbsp;<label for="terms2">我同意 Sealand <a href="/pdf/車輛租賃契約_訂閱式租賃.pdf" onclick="t2=1;" target="_blank">車輛租賃契約_訂閱式租賃</a></label></td>
                                                                            </tr>
                                                                        </table>--}}
                                                                        <div>&nbsp;</div>
