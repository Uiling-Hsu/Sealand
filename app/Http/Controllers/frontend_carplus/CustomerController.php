...
class CustomerController extends Controller
{
    function index($tab_name='') {
        ...
        return view('frontend_carplus.customer',compact('tab','user', 'ords','list_ords','faqs','shopping_spec'));
    }
    ...
    function ord_search(Request $request) {
        ...
        $faqs=Faq::whereStatus(1)->orderBy('sort')->get();
        $shopping_spec=Setting::where('key','shopping_spec')->first()->val;
        return view('frontend_carplus.customer',compact('ord','tab','faqs','user','shopping_spec'));
    }
