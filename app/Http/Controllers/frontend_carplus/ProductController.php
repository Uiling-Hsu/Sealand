...
class ProductController extends Controller
{
    ...
    public function list()
    {
        ...
        return view('frontend_carplus.product_list',compact('products','list_brandcats','list_brandins','list_proareas'));
    }
    ...
    public function search(Request $request)
    {
        ...
        return view('frontend_carplus.search_result', compact('search_products','query'));
    }
