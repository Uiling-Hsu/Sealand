...
class OrdController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend_carplus.ord_list', compact('subscribers','ords'));
    }
    ...
    public function ord_no_paid_list()
    {
        ...
        $ords = Ord::where('user_id', $user->id)
            ...
            ->where('is_paid',0)
            ->orderBy('created_at','DESC')->get();
        return view('frontend_carplus.ord_list', compact('ords'));
    }
    ...
    public function subscriber(Subscriber $subscriber)
    {
        ...
        return view('frontend_carplus.subscriber', compact('subscriber','cate','product','proarea'));
    }
    ...
    public function ord(Ord $ord)
    {
        ...
        return view('frontend_carplus.ord', compact('ord','cate','product','proarea','list_renewtates'));
    }
    ...
    {
        $user=getLoginUser();
        return view('frontend_carplus.user_fee', compact('user'));
    }
