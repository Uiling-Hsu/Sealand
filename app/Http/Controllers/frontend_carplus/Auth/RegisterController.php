...
class RegisterController extends Controller
{
    ...
    */
    ...
    {
        return view('frontend_carplus/auth/register');
    }	
    ...
    protected function saveRegisterForm(Request $request)
    {
	    ...
	    //if(isset($result['success']) && $result['success']) {
		    ...
		    if($validator->fails()) {
			    return redirect(route('carplus.user.register'))
		    ...
		    if($user->id) {
			    ...
			    return redirect(route('carplus.user.register'))->with('modal_failure_message', '會員註冊失敗');
		    }
	    //}
	    //else{
